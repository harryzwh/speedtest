...
var settings = {
	...
	test_order: "IU", //order in which tests will be performed as a string. D=Download, U=Upload, P=Ping+Jitter, I=IP, _=1 second delay
	time_ul_max: 86400, // max duration of upload test in seconds
	time_dl_max: 86400, // max duration of download test in seconds
	...
	time_dlGraceTime: 1, //time to wait in seconds before actually measuring dl speed (wait for TCP window to increase)
